...
public class SimpleTomMeta implements TomMeta {
    ...
    public static JsonElement wrapJson(TomMeta meta) {
        ...
        for (String s : simpleChatMeta.getKeys()) {
            if (simpleChatMeta.jsonObject.has(s)) {
                ...
                object.add(s, wrapJson(simpleChatMeta.metaMap.get(s)));
            } else {
    ...
    public Optional<Long[]> getLongArray(String key) {
        return unpackJsonArray(
                ...
                .flatMap(longs -> Optional.of(longs.toArray(new Long[0])));
    }
